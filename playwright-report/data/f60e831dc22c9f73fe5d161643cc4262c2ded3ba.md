...
- Name: Authentication Flow >> should display auth form with tabs
- Location: /Users/mac/Documents/WORKSPACE/fintechs/exchanges:launchpads/feathered-finance-launch/tests/e2e/auth.spec.ts:15:3
...
Locator: getByRole('heading', { name: 'Welcome to SimplMonie' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for getByRole('heading', { name: 'Welcome to SimplMonie' })

    at /Users/mac/Documents/WORKSPACE/fintechs/exchanges:launchpads/feathered-finance-launch/tests/e2e/auth.spec.ts:17:80
```
