          ...
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Tabs defaultValue={getTimeframeLabel()} className="w-32">
              <TabsList className="grid grid-cols-4 h-7">
                <TabsTrigger value="1D" className="text-xs" onClick={() => setTimeframe('1d')}>1D</TabsTrigger>
                <TabsTrigger value="1W" className="text-xs" onClick={() => setTimeframe('7d')}>1W</TabsTrigger>
                <TabsTrigger value="1M" className="text-xs" onClick={() => setTimeframe('30d')}>1M</TabsTrigger>
                <TabsTrigger value="3M" className="text-xs" onClick={() => setTimeframe('90d')}>3M</TabsTrigger>
              </TabsList>
            </Tabs>
          </CardHeader>
          <CardContent>
              ...
              {isChartLoading ? (
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    />
                    <Area type="monotone" dataKey="BIT" name="Bitcoin" stroke="hsl(var(--primary))" fillOpacity={1} fill="url(#colorBTC)" />
                    <Area type="monotone" dataKey="ETH" name="Ethereum" stroke="hsl(var(--accent))" fillOpacity={1} fill="url(#colorETH)" />
                  </AreaChart>
                </ResponsiveContainer>
              )}
            </div>
                            ...
                            <td className="px-4 py-4">
                              <div className="flex items-center">
                                ...
                                <div>
                                  ...
                                  <div className="text-sm text-muted-foreground">{wallet.crypto_code}</div>
                                </div>
                              </div>
                            </td>
                            <td className="px-4 py-4">
                            ...
                            <td className="px-4 py-4">
                              <div className="flex items-center">
                                ...
                                <div>
                                  ...
                                  <div className="text-sm text-muted-foreground">{account.currency_code}</div>
                                </div>
                              </div>
                            </td>
                            <td className="px-4 py-4">
